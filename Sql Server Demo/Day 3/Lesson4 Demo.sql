...
Select * from Customers Where CustomerID Between 'A' And 'D'
...
--Month Difference
SELECT DATEDIFF(M,GETDATE(),'22/APR/2020')
...
SELECT CHARINDEX('s','HelloStudents',9)
...
Insert Emp Values('1001','Saket',NULL,'40000','10')
Insert Emp Values('1002','Pravin','1001','35000','10')
Insert Emp Values('1003','Mahesh','1002','35000','20')
Insert Emp Values('1004','Ravi','1002','30000','20')
Insert Emp Values('1005','Pragya','1001','20000','10')
Insert Emp Values('1006','Mayur','1003','10000','30')
...
Count(Distinct MGR) as 'No of Managers' from Emp
...
Select DeptNo,Count(*) as 'No of Employees' from Emp Group By DeptNo

Select DeptNo,Sum(salary) from Emp group by deptno

Select DeptNo,MGR,Sum(salary) from Emp group by deptno,Mgr
...
union
Select Deptno as 'Department ID' from Emp
