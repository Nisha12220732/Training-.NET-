...
VALUES (hierarchyid::GetRoot(), 1, 'David', 'Marketing Manager') ;
GO
...
--Sariya reports to David. To insert Sariya's node, you must create an appropriate OrgNode value of data type hierarchyid. 
...
SELECT @Manager1 = hierarchyid::GetRoot()
FROM EmployeeOrg ;

--select @Manager1.GetDescendant(0x58, NULL)

INSERT EmployeeOrg (OrgNode, EmployeeID, EmpName, Title)
VALUES
(@Manager1.GetDescendant(0x58,null), 1306, 'Riya', 'Marketing Spl-2') ; 
